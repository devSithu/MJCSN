            ...
            <div class="col-sm-12">
              <table class="table">
                <tbody>
                  ...
                  <tr>
                    {{-- <td><label for="nrc_number" class="control-label">NRC Number</label></td>
                    <td>
                      <input type="text" class="form-control" name="nrc_number" value="{{ empty($search->nrc_number) ? null : old('nrc_number', $search->nrc_number) }}">
                    </td> --}}
                  ...
                  <tr>
                    ...
                    <td>
                      <input type="text" class="form-control" name="address" value="{{ empty($search->address) ? null : old('address', $search->address) }}">
                    </td> --}}
