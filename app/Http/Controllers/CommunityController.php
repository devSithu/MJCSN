...
class CommunityController extends Controller
{
    ...
    public function getHeaderData($request)
    {
        ...
        // if($request->headers->has('X-UserID') && $request->headers->has('X-Action') && 
        //     $request->headers->has('X-OS') && $request->headers->has('X-OSVersion') && $request->headers->has('X-Version'))
        // {
        //    if($request->headers->has('X-Parameter'))
        //    {
        //         $this->insertData($request);
    ...
    private function appGetUserInfo($request)
    {
        ...
        $userInfo->snrc_image = $request->nrc_image;
